#!/usr/bin/env python3
"""
Script executável para job de coleta histórica de dados climáticos
"""
import os
import sys
import logging
...
def main():
    ...
    logger.info("📅 Iniciando job de coleta histórica de dados climáticos...")
    
    try:
        # Configurar Flask app context
        from flask import Flask
        from src.models.user import db
        from src.jobs.climate_collector import run_historical_collection
        ...
        with app.app_context():
            # Executar coleta histórica (últimos 7 dias)
