#!/usr/bin/env python3
"""
Script executável para job de coleta de dados climáticos
"""
import os
import sys
import logging
...
def main():
    ...
    logger.info("🌤️  Iniciando job de coleta de dados climáticos...")
    
    try:
        # Configurar Flask app context
        from flask import Flask
        from src.models.user import db
        from src.jobs.climate_collector import run_current_collection
